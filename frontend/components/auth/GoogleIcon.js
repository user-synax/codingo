export function GoogleIcon({ className }) {
  return (
    ...
    >
      <path
        fill="#4285F4"
        d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92a5.06 5.06 0 0 1-2.2 3.31v2.75h3.57c2.08-1.92 3.27-4.74 3.27-8.07Z"
      />
      <path
        fill="#34A853"
      ...
      <path
        fill="#FBBC05"
        d="M5.84 14.12A6.97 6.97 0 0 1 5.47 12c0-.74.13-1.45.36-2.12V7.04H2.18A11 11 0 0 0 1 12c0 1.78.43 3.45 1.18 4.96l3.66-2.84Z"
      />
      <path
        fill="#EA4335"
